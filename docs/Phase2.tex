...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=2in]{UML_Encryption.png}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=2in]{UML_Client.png}
		\caption{Client UML}
		\label{Client UML}
	\end{center}
\end{figure}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=2in]{UML_Server.png}
		\caption{Server UML}
		\label{Server UML}
	\end{center}
\end{figure}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=2in]{UML_Communication.png}
